...
public class CapeTextures {
    ...
    public static Identifier getCapeTexture() {
        return switch(config.cape_texture) {
            ...
            case PROUD_UTILITY_USER -> Identifier.of("mlumm", "textures/cape_flintknock.png"); //
            ...
            case S15GANG_MMU -> Identifier.of("mlumm", "textures/cape_s15_mmu.png"); //
            ...
            case S15GANG_TORMENT -> Identifier.of("mlumm", "textures/cape_s15_torment.png"); //
            case S15GANG_CAP -> Identifier.of("mlumm", "textures/cape_s15_cap.png"); //
        };
    }
}
